...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnLanguageCompat( oLanguage )
		{
			...
			if ( !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
				oDefaults.sEmptyTable === "Hiçbir sonuç bulunamadý (data yok)" )
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Kayýt bulunamadý (data yok)
			 *  @dtopt Language
			 * 
			 *  @example
			 *    $(document).ready( function() {
			 *      $('#example').dataTable( {
			 *        "oLanguage": {
			 *          "sEmptyTable": "Kayýt bulunamadý (data yok)"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Gösterilen kayýt sayýsý 0",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Hiç bir sonuç bulunamadý."
		},
